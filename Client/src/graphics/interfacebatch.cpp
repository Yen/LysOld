...
namespace lys
{
	...
	static ShaderProgram createShader()
	{
		...
		shaders.push_back(ShaderData(GL_VERTEX_SHADER, ShaderProgram::createShaderList(utils::readFile("data/shaders/interfacebatch-v.glsl"))));
		shaders.push_back(ShaderData(GL_FRAGMENT_SHADER, ShaderProgram::createShaderList(utils::readFile("data/shaders/interfacebatch-f.glsl"))));
